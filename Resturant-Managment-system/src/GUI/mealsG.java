...
public class mealsG extends JPanel { // start of the class
	buttoncustom add, delete, update, list, search, addTheMeal, deleteTheMeal, updateTheMeal, searchForMeal; // declaring buttons
	labelcustom title; // declaring labels
	JTextField name, price, newPrice, nameForSearch; // declaring text field
	JComboBox<String> meals; // declaring the combo box
	Meals meal = new Meals(); // object from Meals class
	Object col[] = {"Meal Name", "Price"}; // declaring the column of the table
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (mealName.equals("") || mealPrice == 0 || mealName.matches("^[1-9]*$")) {
						...
						Object[] rowData = {mealName, mealPrice};
